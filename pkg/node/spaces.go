...
func (client *SpacesClient) GetRootAnchors(ctx context.Context) ([]*RootAnchor, error) {
	rootAnchors := make([]*RootAnchor, 0)
	err := client.Rpc(ctx, "getrootanchors", []interface{}{}, &rootAnchors)
	if err != nil {
		return nil, err
	}
	return rootAnchors, nil
}
